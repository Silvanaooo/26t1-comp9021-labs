...
def f3_1(L: list[int]) -> None:
    ...
    # def _f3(L, n):
    #     if n == len(L): # Base case: no more levels.
    #         return
    #     if L[n] <= 0: # Nothing to print at this level (zero or negative).
    #         return
    #     for _ in range(L[n] - 1):
    #         print('\t' * n, 'X', sep='')
    #         _f3(L, n + 1)
    #     print('\t' * n, 'X', sep='') # Print the final line at this level (no block after it).
    # ============================================================================ #
